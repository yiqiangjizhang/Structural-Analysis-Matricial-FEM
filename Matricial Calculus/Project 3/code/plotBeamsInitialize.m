...
% Open figure window
fig = figure('units','centimeters','Position',[2,2,24,16]);
% Interpreter latex
...
ylabel("$u_y \ \left( \mathrm{m} \right)$");
grid on;
grid minor;
title("Deflection");
...
xlim([0,L]);
xlabel("$x \ \left( \mathrm{m} \right)$");
ylabel("$\theta_z \ \left( \mathrm{rad} \right)$");
grid on;
grid minor;
title("Rotation");
...
xlim([0,L]);
xlabel("$x \ \left( \mathrm{m} \right)$");
ylabel("$F_y \ \left( \mathrm{N} \right)$");
grid on;
grid minor;
title("Shear force");
...
xlim([0,L]);
xlabel("$x \ \left( \mathrm{m} \right)$");
ylabel("$M_z \ \left( \mathrm{N} \, \mathrm{m} \right)$");
grid on;
grid minor;
