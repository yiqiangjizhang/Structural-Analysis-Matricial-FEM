...
%--------------------------------------------------------------------------
% NameFileMeshDATA = 'GEOMETRY_2D_1x_nodes' ;   % For reading data from GID.
NameFileMeshDATA = 'GEOMETRY_2D_5x_nodes' ;   % For reading data from GID.
% NameFileMeshDATA = 'GEOMETRY_2D_10x_nodes' ;   % For reading data from GID.
% NameFileMeshDATA = 'GEOMETRY_2D_30x_nodes' ;   % For reading data from GID.
% -----------------------------------------------------------
% 2. Material data. 
% --------------------------------------------------------------
