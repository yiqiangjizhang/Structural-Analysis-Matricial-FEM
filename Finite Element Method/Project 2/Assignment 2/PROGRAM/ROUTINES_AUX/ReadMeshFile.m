...
if fid <0 
    error(['File ',nameMSH,' cannot be open. Make sure it has been generated by exporing the ASCII file'])
end
...
LIMITE_ELEM = 50*num_nodos1 ; 
[OkFindRes ,num_elementos_1] = ReadUntCount(fid,'End',nnode_elem1+1+READ_MATERIAL_COLUMN,LIMITE_ELEM); %% counting elements of mesh 1


if OkFindRes == 0
    error(['You have probably forgotten to assign materials in the GID file --> Data...Materials... (remember to load "Problem_Type_Simple") '])
end
...
if isempty(CONNECTbound)
    error('You have forgotten to generate the  Boundary Mesh. ---> Mesh> Create Boundary Mesh (and export again) ')
