function GidPostProcess2D(COOR,CN,TypeElement,d,qheatGLO,NAME_INPUT_DATA,posgp,NameFileMesh); 
...
GidResults2DFE(NameFile_res,COOR,CN,TypeElement,d,qheatGLO,NAME_INPUT_DATA,posgp);
