function[d strainGLO stressGLO React posgp K_ll M_ll DOFl]  = SolveElastFE(COOR,CN,TypeElement,TypeElementB, celasglo,  DOFr,dR,...  
...
disp('Solving...')
[d strainGLO stressGLO React posgp K_ll M_ll DOFl] = SolveELAS(K,Fb,Ftrac,dR,DOFr,COOR,CN,TypeElement,celasglo,typePROBLEM,celasgloINV,DATA,M) ; 
